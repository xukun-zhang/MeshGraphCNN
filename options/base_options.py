...
class BaseOptions:
    ...
    def initialize(self):
        # data params
        self.parser.add_argument('--dataroot', default="/home/zxk/code/P2ILF-Mesh/Ours-0611-7-5/datasets/All_data", help='path to meshes (should have subfolders train, test)')
        ...
        self.parser.add_argument('--pool_res', nargs='+', default=[22000, 3200, 1600, 800], type=int, help='pooling res')
