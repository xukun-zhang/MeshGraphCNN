...
class PointNet2_partseg(nn.Module):
    def __init__(self, num_classes, normal_channel=False):
        super(PointNet2_partseg, self).__init__()
        if normal_channel:
    ...
    def forward(self, xyz, cls_label_one_hot):
        ...
        cls_label_one_hot = cls_label_one_hot.view(B,16,1).repeat(1,1,N)
...
class DGCNN_partseg(nn.Module):
    def __init__(self, k, seg_num_all):
    ...
    def forward(self, x, l):
        # print("x.shape, l.shape:", x.shape, l.shape)
        batch_size = x.size(0)
        num_points = x.size(2)
